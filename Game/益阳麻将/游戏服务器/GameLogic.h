...
public:
	...
	//碰牌判断
	BYTE EstimatePengCard(BYTE cbCardIndex[MAX_INDEX], BYTE cbCurrentCard, BYTE cbKingCard[]);
	//杠牌判断
	BYTE EstimateGangCard(BYTE cbCardIndex[MAX_INDEX], BYTE cbCurrentCard, BYTE cbKingCard[]);
	//听牌判断
	BYTE EstimateTingCard(BYTE cbCardIndex[MAX_INDEX],tagWeaveItem WeaveItem[], BYTE cbItemCount, BYTE IsGangData[MAX_INDEX],BYTE &GangCount,BYTE cbKingCard[]);
	bool EstimateTingCard(BYTE cbCardIndex[MAX_INDEX], tagWeaveItem WeaveItem[], BYTE cbItemCount, BYTE byOutCard,BYTE cbKingCard[]);


	//动作判断
public:
	//杠牌分析
	BYTE AnalyseGangCard(BYTE cbCardIndex[MAX_INDEX], tagWeaveItem WeaveItem[], BYTE cbItemCount, tagGangCardResult & GangCardResult, BYTE cbKingCard[]);
	//吃胡分析(无王牌)
	...
	//吃胡分析(王牌)
	BYTE AnalyseKingChiHuCard(BYTE cbCardIndex[MAX_INDEX], tagWeaveItem WeaveItem[], BYTE cbItemCount, BYTE cbCurrentCard, BYTE cbKingCard, WORD wChiHuRight, tagChiHuResult & ChiHuResult);
	//吃胡分析（有王牌）
	BYTE AnalyseChiHuLevity(BYTE cbCardIndex[MAX_INDEX],tagWeaveItem WeamItem[], BYTE cbWeaveCount, BYTE cbCurrentCard, WORD wChiHuRight, tagChiHuResult &ChiHuResult,BYTE cbKingCard[],BYTE cbKingCount,BYTE cbReCardIndex[MAX_INDEX], bool bIsMe=false);
...
public:	
	...
	//听牌判断
	bool IsCanTingCard(BYTE cbCardIndex[MAX_INDEX], tagWeaveItem WeaveItem[], BYTE cbWeaveCount, BYTE cbKingCard[]);
