...
protected:
	...
	CPngImage                       m_ImageTingFlag;                    //听牌标记
	CPngImage                       m_ImageKingCardBack;                //王牌背景
	CPngImage                       m_ImageKingCardNum;                 //王牌数据
