...
struct tagPlatformFrameImage
{
	...
	//框架按钮
	UINT							uBtFrameMin;						//最小化
	UINT							uBtFrameClose;						//关闭
	UINT							uBtFrameMax;						//最大化
	UINT							uBtFrameResore;						//恢复
	UINT							uBtFrameRetrue;						//返回  DEF_IDB_FRAME_BT_RETRUE 
	UINT							uBtFrameRelogon;					//重新登录 DEF_IDB_FRAME_BT_RELOGON
	UINT							uBtFrameSwitch;						//资源标识
	UINT							uBtFrameSelfSet;					//资源标识
	UINT							uBtFrameOption;						//开启声音
	UINT							uBtFrameCloseSound;					//静音
	...
	//导航按钮
	UINT							uFrameNavigation[9];				//资源标识

	UINT							uBtDepository;						//藏宝阁
	UINT							uBtFriend;							//好友
	UINT							uBtShop;							//商城
	UINT							uBtGamePlazy;						//游戏大厅
	UINT							uBtTask;							//任务
	UINT							uBtTool;							//道具
	UINT							uBtHelp;							//帮助
...
struct tagPlazaViewImage
{
	...
	//登陆按钮
	UINT							uBtLogon;							//资源标识
	UINT							uBtAccount;							//资源标识
	UINT							uBtGetPassword;						//资源标识
	UINT							uBtVisitWeb;						//资源标识
	UINT							uBtQuit;							//资源标识
	UINT							uBtClear;							//资源标识
	UINT							uBtCheckNo;							//资源标识
	UINT							uBtCheckOff;						//资源标识
	UINT							uBtRadioNo;							//资源标识
	UINT							uBtRadioOff;						//资源标识
...
struct tagServerViewImage
{
	...
	UINT							uBtChatChannel;						//聊天——切换频道
	UINT							uBtChatFont;						//聊天——头像
	UINT							uBtChatChatLog;						//聊天——聊天记录
