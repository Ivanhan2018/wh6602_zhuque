...
CGameLogic::pPeekFun CGameLogic::PeekFun[14]=
{
	//CGameLogic::PeekGoodCardType1,
	//CGameLogic::PeekGoodCardType2,
	CGameLogic::SetCardType1,
	CGameLogic::SetCardType2,
	CGameLogic::SetCardType3,
	CGameLogic::SetCardType4,
	CGameLogic::SetCardType5,
	CGameLogic::SetCardType6,
	CGameLogic::SetCardType7,
	CGameLogic::SetCardType8,
	CGameLogic::SetCardType9,
	CGameLogic::SetCardType10,
	CGameLogic::SetCardType11,
	CGameLogic::SetCardType12,
	CGameLogic::SetCardType13,
	CGameLogic::SetCardType14
};
//CGameLogic::pPeekFun CGameLogic::SetFun[3]={CGameLogic::SetCardType1,CGameLogic::SetCardType2,CGameLogic::SetCardType3};
...
const char * CGameLogic::GetCardName(unsigned char nCardID)
{
...
BYTE CGameLogic::GetCardType(const BYTE cbCardData[], BYTE cbCardCount)
{
	...
	case 2:	//对牌火箭
		{
			//牌型判断
			if (((cbCardData[0]==0x4F)&&(cbCardData[1]==0x4E))||((cbCardData[0]==0x4F)&&(cbCardData[1]==0x4E))) return CT_MISSILE_CARD;
...
bool CGameLogic::PeekCardDataVec(vector<BYTE>& the_vector,const BYTE v,const int vNum,vector<BYTE>& v1) 
{
	//取动态数组中的nNum个v
	v1.clear();//add
	bool bret=false;
...
bool CGameLogic::PeekCardDataVec(vector<BYTE>& the_vector,const int nType,const BYTE v,const int N,vector<BYTE>& v1) 
{
...
int	CGameLogic::GetRandJQKA2(void)
{
	int nret=0; 
	for(;;)
	{
...
int	CGameLogic::GetRandA2Missile(void)
{
	int nret=0; 
	for(;;)
	{
		nret=rand()%15+1;
		if(nret==14||nret==15||nret==1||nret==2)
			break;
	}
...
int	CGameLogic::GetRandMissile(void)
{
	int nret=rand()%2+14; 
	return nret;
}
...
int	CGameLogic::GetRandNoMissile(void)
{
	int nret=rand()%13+1; 
	return nret;
}
...
int	CGameLogic::GetRandJQKA2Missile(void)
{
	int nret=0; 
	for(;;)
	{
...
//bool CGameLogic::PeekGoodCardType1(vector<BYTE>& the_vector,vector<BYTE>& V1)
//{
...
//		{
//			the_vector.insert(the_vector.end(),V1.begin(),V1.end());
//			V1.clear();
//			return false;
//		}
//	}
...
//}
//
//bool CGameLogic::PeekGoodCardType2(vector<BYTE>& the_vector,vector<BYTE>& V2)
//{
...
//		if(nRCount>=nMaxRcount)
//		{
//			the_vector.insert(the_vector.end(),V2.begin(),V2.end());
//			V2.clear();
//			return false;
//		}
//	}
...
//取出3张随机的底牌
bool CGameLogic::PeekRandBackCard(vector<BYTE>& the_vector,vector<BYTE>& Vback)
{
	int nRCount=0;
	for(int i=0;i<3;i++)
		for(;;nRCount++)
		{
			...
			//取动态数组中的单牌
			vector <BYTE> v0;
			bool bret=CGameLogic::PeekCardDataVec(the_vector,g,1,v0);
			if(bret)
			{
...
bool CGameLogic::SetCardType1(vector <BYTE> &TheVector,vector <BYTE> &ResultVector )
{
	int nRCount=0;
	int nMaxRcount=10000;
	for(;;nRCount++)
	{
		...
		//取动态数组中的炸弹a2(4)
		vector <BYTE> v0;
		bool bret=PeekCardDataVec(TheVector,a2,4,v0);
		if(bret)
		{
			ResultVector.insert(ResultVector.end(),v0.begin(),v0.end());
			//ResultVector.swap(v0);
			break;
		}
		//if(nRCount>=nMaxRcount)return false;
		if(nRCount>=nMaxRcount)
		{
			TheVector.insert(TheVector.end(),ResultVector.begin(),ResultVector.end());
			ResultVector.clear();
			return false;
		}
	}
	...
	} while (!PeekCardDataVec(TheVector,iWang,1,v2));
	//赋值
	ResultVector.insert(ResultVector.end(),v2.begin(),v2.end());
	...
	} while (!PeekCardDataVec(TheVector,3,iFeiji,2,v3));
	//赋值
	ResultVector.insert(ResultVector.end(),v3.begin(),v3.end());
	...
	for(int i=0;i<2;i++)
	{
		...
		} while (!PeekCardDataVec(TheVector,iDuiZi,2,v4));
		//赋值
		ResultVector.insert(ResultVector.end(),v4.begin(),v4.end());
	}
	//取单牌
	for(int i=0;i<2;i++)
	{
		...
		} while (!PeekCardDataVec(TheVector,iDanPai,1,v5));
		//赋值
		ResultVector.insert(ResultVector.end(),v5.begin(),v5.end());
	}
	assert(ResultVector.size()==17);
	return true;
}

bool CGameLogic::SetCardType2(vector <BYTE> &TheVector,vector <BYTE> &ResultVector )
{
	int nRCount=0;
	int nMaxRcount=10000;
	//取炸弹
	...
	} while (!PeekCardDataVec(TheVector,iFour,4,v1));
	//赋值
	ResultVector.insert(ResultVector.end(),v1.begin(),v1.end());
	...
	} while (!PeekCardDataVec(TheVector,1,iShun,6,v3));
	//赋值
	ResultVector.insert(ResultVector.end(),v3.begin(),v3.end());
	...
	} while (!PeekCardDataVec(TheVector,2,iSanShun,3,v4));
	//赋值
	ResultVector.insert(ResultVector.end(),v4.begin(),v4.end());
	assert(ResultVector.size()==17);
	return true;
...
bool CGameLogic::SetCardType3(vector <BYTE> &TheVector,vector <BYTE> &ResultVector )
{
	int nRCount=0;
	int nMaxRcount=10000;
	//取炸弹
	...
	} while (!PeekCardDataVec(TheVector,2,iWuShun,5,v3));
	//赋值
	ResultVector.insert(ResultVector.end(),v3.begin(),v3.end());
	...
	} while (!PeekCardDataVec(TheVector,iDui,2,v4));
	//赋值
	ResultVector.insert(ResultVector.end(),v4.begin(),v4.end());
	assert(ResultVector.size()==17);
	return true;
...
bool CGameLogic::SetCardType4(vector<BYTE>& the_vector,vector<BYTE>& V1)
{
	//牌型4(17张)：V---炸弹a1(4)-->V1  +  V---王牌w1(1)-->V1  +  V---顺子b1(7)-->V1  +  V---三带二(s1,d1)(5)-->V1
	//srand( (unsigned)time( NULL ) );
	//vector <BYTE> V1;
	int nRCount=0;
	int nMaxRcount=10000;
	...
	for(;;nRCount++)
	{
		int w1=GetRandMissile();
		//取动态数组中的王牌w1(1)
		vector <BYTE> v0;
		bool bret=PeekCardDataVec(the_vector,w1,1,v0);
		if(bret)
		{
			V1.insert(V1.end(),v0.begin(),v0.end());
			break;
	...
	nRCount=0;
		for(;;nRCount++)
		{
			int b1=GetRandNoMissile();
			//取动态数组中的顺子(7)
			vector <BYTE> v0;
			bool bret=PeekCardDataVec(the_vector,1,b1,7,v0);
			if(bret)
			{
				V1.insert(V1.end(),v0.begin(),v0.end());
				break;
		...
		for(;;nRCount++)
		{
			int s1=GetRandNoMissile();
			//取动态数组中的三张s1(3)
			vector <BYTE> v0;
			bool bret=PeekCardDataVec(the_vector,s1,3,v0);
			if(bret)
			{
				V1.insert(V1.end(),v0.begin(),v0.end());
				break;
		...
		for(;;nRCount++)
		{
			int d1=GetRandNoMissile();
			//取动态数组中的对子d1(2)
			vector <BYTE> v0;
			bool bret=PeekCardDataVec(the_vector,d1,2,v0);
			if(bret)
			{
				V1.insert(V1.end(),v0.begin(),v0.end());
				break;
...
bool CGameLogic::SetCardType5(vector<BYTE>& the_vector,vector<BYTE>& V1)
{
	//牌型5(17张)：V---炸弹a1(4)-->V1  +  V---王牌w1(1)-->V1  +  V---顺子b1(8)-->V1  +  V---三带一(s1,g1)(4)-->V1
	//srand( (unsigned)time( NULL ) );
	//vector <BYTE> V1;
	int nRCount=0;
	int nMaxRcount=10000;
	...
	for(;;nRCount++)
	{
		...
		//取动态数组中的顺子(8)
		vector <BYTE> v0;
		bool bret=PeekCardDataVec(the_vector,1,b1,8,v0);
		if(bret)
		{
			V1.insert(V1.end(),v0.begin(),v0.end());
			break;
...
bool CGameLogic::SetCardType6(vector<BYTE>& the_vector,vector<BYTE>& V1)
{
	//牌型6(17张)：V---炸弹a1(4)-->V1  +  V---王牌w1(1)-->V1  +  V---顺子b1(10)-->V1  +  V---二张单牌(gi>=A)(2)-->V1
	//srand( (unsigned)time( NULL ) );
	//vector <BYTE> V1;
	int nRCount=0;
	int nMaxRcount=10000;
	...
	for(;;nRCount++)
	{
		...
		//取动态数组中的顺子(10)
		vector <BYTE> v0;
		bool bret=PeekCardDataVec(the_vector,1,b1,10,v0);
		if(bret)
		{
			V1.insert(V1.end(),v0.begin(),v0.end());
			break;
...
bool CGameLogic::SetCardType7(vector<BYTE>& the_vector,vector<BYTE>& V1)
{
	//牌型7(17张)：V---炸弹a1(4)-->V1  +  V---王牌w1(1)-->V1  +  V---顺子b1(9)-->V1  +  V---三不带(s1)(3)-->V1
	//srand( (unsigned)time( NULL ) );
	//vector <BYTE> V1;
	int nRCount=0;
	int nMaxRcount=10000;
	...
	for(;;nRCount++)
	{
		...
		//取动态数组中的顺子(9)
		vector <BYTE> v0;
		bool bret=PeekCardDataVec(the_vector,1,b1,9,v0);
		if(bret)
		{
			V1.insert(V1.end(),v0.begin(),v0.end());
			break;
...
bool CGameLogic::SetCardType8(vector<BYTE>& the_vector,vector<BYTE>& V1)
{
	//牌型8(17张)：V---炸弹a1(4)-->V1  +  V---王牌w1(1)-->V1  +  V---顺子b1(5)-->V1  +  V---飞机e1(6)-->V1 + V---单牌g1(1)-->V1
	//srand( (unsigned)time( NULL ) );
	//vector <BYTE> V1;
	int nRCount=0;
	int nMaxRcount=10000;
	...
	for(;;nRCount++)
	{
		...
		//取动态数组中的顺子(5)
		vector <BYTE> v0;
		bool bret=PeekCardDataVec(the_vector,1,b1,5,v0);
		if(bret)
		{
			V1.insert(V1.end(),v0.begin(),v0.end());
			break;
...
bool CGameLogic::SetCardType9(vector<BYTE>& the_vector,vector<BYTE>& V1)
{
	//牌型9(17张)：V---炸弹a1(4)-->V1  +  V---王牌w1(1)-->V1  +  V---三顺b1(6)-->V1  +  V---三带一s1,g1(4)-->V1 + V---对子d1(2)-->V1
	//srand( (unsigned)time( NULL ) );
	//vector <BYTE> V1;
	int nRCount=0;
	int nMaxRcount=10000;
	...
	for(;;nRCount++)
	{
		...
		//取动态数组中的三顺(6)
		vector <BYTE> v0;
		bool bret=PeekCardDataVec(the_vector,2,b1,3,v0);
		if(bret)
		{
			V1.insert(V1.end(),v0.begin(),v0.end());
			break;
	...
	for(;;nRCount++)
	{
		int g1=GetRandNoMissile();//GetRandA2Missile();
		//取动态数组中的单牌(1)
		vector <BYTE> v0;
		bool bret=PeekCardDataVec(the_vector,g1,1,v0);
		if(bret)
...
bool CGameLogic::SetCardType10(vector<BYTE>& the_vector,vector<BYTE>& V1)
{
	//牌型10(17张)：V---炸弹a1(4)-->V1  +  V---王牌w1(1)-->V1  +  V---四顺b1(8)-->V1  +  V---三带一s1,g1(4)-->V1
	//srand( (unsigned)time( NULL ) );
	//vector <BYTE> V1;
	int nRCount=0;
	int nMaxRcount=10000;
	...
	for(;;nRCount++)
	{
		...
		//取动态数组中的四顺(8)
		vector <BYTE> v0;
		bool bret=PeekCardDataVec(the_vector,2,b1,4,v0);
		if(bret)
		{
			V1.insert(V1.end(),v0.begin(),v0.end());
			break;
...
bool CGameLogic::SetCardType11(vector<BYTE>& the_vector,vector<BYTE>& V1)
{
	//牌型11(17张)：V---炸弹a1(4)-->V1  +  V---王牌w1(1)-->V1  +  V---飞机e1(6)-->V1  +  V---三带一s1,g1(4)-->V1 + V---二张单牌(gi>=A)(2)-->V1
	//srand( (unsigned)time( NULL ) );
	//vector <BYTE> V1;
	int nRCount=0;
	int nMaxRcount=10000;
...
bool CGameLogic::SetCardType12(vector<BYTE>& the_vector,vector<BYTE>& V1)
{
	//牌型12(17张)：V---顺子b1(10)-->V1  +  V---三带二s1,d1(5)-->V1 + V---一对(d1>=A)(2)-->V1
	int nRCount=0;
	int nMaxRcount=10000;
	for(;;nRCount++)
	{
	...
	for(;;nRCount++)
	{
		int d1=GetRandNoMissile();//GetRandA2Missile();
		//取动态数组中的一对d1(2)
		vector <BYTE> v0;
		bool bret=PeekCardDataVec(the_vector,d1,2,v0);
		if(bret)
...
bool CGameLogic::SetCardType13(vector<BYTE>& the_vector,vector<BYTE>& V1)
{
	//牌型13(17张)：V---顺子b1(9)-->V1  +  V---飞机e1(6)-->V1 + V---一对d1(2)-->V1
	int nRCount=0;
	int nMaxRcount=10000;
	for(;;nRCount++)
	{
...
bool CGameLogic::SetCardType14(vector<BYTE>& the_vector,vector<BYTE>& V1)
{
	//牌型14(17张)：V---顺子b1(8)-->V1  +  V---飞机e1(6)-->V1 + V---一对d1(2)-->V1 + V---单牌g1(1)-->V1
	int nRCount=0;
	int nMaxRcount=10000;
	for(;;nRCount++)
	{
