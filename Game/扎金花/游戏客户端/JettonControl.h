...
protected:
	...
	//位置变量
protected:
	CArrayTemplate<WORD>			m_arJetIndex;						//绘画筹码
	CArrayTemplate<CPoint>			m_arJetExcusions;					//绘画位置
	

	//动画变量
protected:
	CArrayTemplate<tagJetPending>	m_arJetPending;						//待决筹码

	CArrayTemplate<WORD>			m_arIndexPending;					//待决筹码索引
	CArrayTemplate<CPoint>			m_arExcusionsPend;					//偏移
	CArrayTemplate<INT>				m_arStepCount;						//步数
	CArrayTemplate<INT>				m_arXStep;							//X步长
	CArrayTemplate<INT>				m_arYStep;							//Y步长
