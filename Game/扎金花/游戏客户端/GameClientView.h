...
protected:
	...
	CPoint							m_ptlGems[GAME_PLAYER];				//宝石
	CPoint							m_ptClass[GAME_PLAYER];				//等级
...
protected:
	...
	//按钮控件
public:
	CRgnButton						m_btStart;							//开始按钮

	CRgnButton						m_btMaxScore;						//最大按钮
	CRgnButton						m_btMinScore;						//清理按钮
	CRgnButton						m_btCancel;							//清理按钮
	CRgnButton						m_btConfirm;						//取消按钮

	CRgnButton						m_btAddScore;						//加注按钮
	CRgnButton						m_btFollow;							//跟注按钮
	CRgnButton					    m_btGiveUp;							//放弃按钮
	CRgnButton					    m_btLookCard;						//看牌按钮
	CRgnButton						m_btCompareCard;					//比牌按钮
	CRgnButton					    m_btOpenCard;						//开牌按钮
	...
	//控件变量
public:
	//CGameScoreView				m_ScoreView;					    //成绩窗口
...
protected:
	...
	CPngImage						m_ImageCompareCard;					//比牌提示
