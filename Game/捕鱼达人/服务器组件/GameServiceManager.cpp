...
CGameServiceManager::CGameServiceManager()
{
	...
	m_GameServiceAttrib.wChairCountMin=1;
	m_GameServiceAttrib.wChairCountMax=GAME_PLAYER;//Update<cxf>;DateTime<2012-03-27>;Description<服务器wChairCount已经改为wChairCountMin>
	...
	lstrcpyn(m_GameServiceAttrib.szDescription,TEXT("捕鱼达人游戏服务组件"),CountArray(m_GameServiceAttrib.szDescription));
