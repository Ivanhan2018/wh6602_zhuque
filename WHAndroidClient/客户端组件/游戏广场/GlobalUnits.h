...
#include "..\下载组件\DownLoadServiceInterface.h"
...
protected:
	...
	CStringArray						m_strarrAppCmdLine;				//程序初始时命令行
...
public:
	...
	CDownLoadService					m_DownLoadService;				//下载服务
...
public:
	...
	//设置，获取程序命令行
	void CGlobalUnits::SaveApplicationCmdLine(CStringArray &strArray){ m_strarrAppCmdLine.Copy(strArray); }
	CStringArray & GetApplicationCmdLine() { return m_strarrAppCmdLine; }
...
public:
	...
	//下载游戏	wType:1下载;2更新
	bool DownLoadClient(LPCTSTR pszKindName, WORD wKindID, bool bDisplay, WORD wType);
};
