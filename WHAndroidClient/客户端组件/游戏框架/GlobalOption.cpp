...
CGlobalOption::CGlobalOption()
{
	...
	m_wGameGenre=GAME_GENRE_GOLD;

	//颜色设置
	m_crChatTX=RGB(255,255,255);
	m_crMsgName=RGB(0,255,12);
...
void CGlobalOption::LoadOptionParameter()
{
	...
	//普通字体颜色
	m_crMsgName		 = RGB(0,255,12);
	m_crMsgNormal	 = RGB(255,255,0);

	//系统字体颜色
	m_crMsgSysHead	 = RGB(255,0,0);
	m_crMsgSysString = RGB(0,255,252);
	return;
}
