...
bool __cdecl CServerListCenter::LoadServerList(tagDataBaseInfo & DataBaseInfo)
{
	...
	try
	{
		...
		//连接数据库
		ServerInfoDBModule->SetConnectionInfo(/*DataBaseInfo.szDataBaseAddr*/szDataBaseAdr,DataBaseInfo.wDataBasePort,DataBaseInfo.szDataBaseName,DataBaseInfo.szDataBaseUser,DataBaseInfo.szDataBasePass);
