...
#define PORT_CONTROL_SERVER				9002		//控制服务器
...
void CInitParamter::InitParamter()
{
	...
	m_wListenPort=PORT_CONTROL_SERVER;
...
void CInitParamter::LoadInitParamter()
{
	...
	_snprintf(szRegName,sizeof(szRegName),TEXT("Software\\%s\\ControlServer"),szSystemRegKey);
