...
bool __cdecl CPlatformResource::GetPlazaViewImage(tagPlazaViewImage * PlazaViewImage)
{
	...
	//登陆界面按钮
	PlazaViewImage->uBtLogon =  DEF_IDB_BT_LOGON;
	PlazaViewImage->uBtQuit  =  DEF_IDB_BT_QUIT;
	PlazaViewImage->uBtVisitWeb=DEF_IDB_BT_WEB;
	PlazaViewImage->uBtAccount= DEF_IDB_BT_REGIST;
	PlazaViewImage->uBtGetPassword=DEF_IDB_BT_ACCOUNT;
	PlazaViewImage->uBtClear = DEF_IDB_BT_CLEAR_USER;
	PlazaViewImage->uBtCheckNo = DEF_IDB_BTN_CHECK;
	PlazaViewImage->uBtCheckOff = DEF_IDB_BTN_CHECK_OFF;
	PlazaViewImage->uBtGameHelp = DEF_IDB_BTN_LOGON_GAMEHLEP;				
	PlazaViewImage->uBtGameShop = DEF_IDB_BTN_LOGON_SHOP;
	PlazaViewImage->uBtGameClinet = DEF_IDB_BTN_LOGON_CLEINT;
	PlazaViewImage->uBtKey = DEF_IDB_BTN_LOGON_KEY;
	PlazaViewImage->uBtRadioNo = DEF_IDB_BTN_RADIO_ON;
	PlazaViewImage->uBtRadioOff = DEF_IDB_BTN_RADIO_OFF;
...
bool __cdecl CPlatformResource::GetServerViewImage(tagServerViewImage * ServerViewImage)
{
	...
	ServerViewImage->uBtChatFont= DEF_IDB_BT_CHAT_FONT;
	ServerViewImage->uBtChatChannel=DEF_IDB_BT_CHAT_CHANNEL;
	ServerViewImage->uBtChatChatLog=DEF_IDB_BTN_CHAT_CHAT_LOG;
...
bool __cdecl CPlatformResource::GetPlatformFrameImage(tagPlatformFrameImage * PlatformFrameImage)
{
	...
	PlatformFrameImage->uBtFrameRetrue=DEF_IDB_FRAME_BT_RETRUE;
	PlatformFrameImage->uBtFrameRelogon=DEF_IDB_FRAME_BT_RELOGON;
	...
	PlatformFrameImage->uBtFrameCloseSound=DEF_IDB_BTN_GAMEPLAZY_CLOSESOUND;
	...
	PlatformFrameImage->uFrameNavigation[7]=DEF_IDB_FRAME_BT_NAVIGATION_8;
	PlatformFrameImage->uFrameNavigation[8]=DEF_IDB_FRAME_BT_NAVIGATION_9;

	PlatformFrameImage->uBtDepository=DEF_IDB_BT_DEPOSITORY;
	PlatformFrameImage->uBtFriend=DEF_IDB_BT_FRIEND;
	PlatformFrameImage->uBtShop=DEF_IDB_BT_SHOP;
	PlatformFrameImage->uBtTask=DEF_IDB_BT_TASK;
	PlatformFrameImage->uBtTool=DEF_IDB_BT_TOOL;
	PlatformFrameImage->uBtHelp=DEF_IDB_BTN_GAMEROOM_HELP;
	PlatformFrameImage->uBtGamePlazy=DEF_IDB_BT_GAME_PLAZY;
	return true;
}
