...
protected:
	...
	LONGLONG                            m_lRoundRevenue;                //每一局税收
...
protected:
	...
	DWORD                               m_dwRoundPlayTime;              //每一局的游戏时间
	TCHAR								m_szPassword[PASS_LEN];			//用户密码
	BOOL								m_bIsPresentOnline[4];			//是否在线赠送{15,30,60,120}
	BOOL								m_bIsUpgradePresent[7];			//是否升级赠送{2,3,4,5,6,7,8}
