...
echo 目标客户端资源路径
set dstClientDebug=%prevPath%运行\ClientDebug
echo %dstClientDebug%
set dstClientRelease=%prevPath%运行\clientrelease
...
echo 目标服务端资源路径
set dstServerDebug=%prevPath%运行\ServDebug
set dstServerRelease=%prevPath%运行\ServRelease
