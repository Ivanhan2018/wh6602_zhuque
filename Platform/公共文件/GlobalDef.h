...
#define PORT_LOGON_SERVER				10000								//登陆服务器
...
//#define GAME_GENRE_CBWS                 0x000a                              //宝石类型
...
struct tagGameServer
{
	...
	DWORD							    dwServerAddrCNN;				    //电信房间地址 彭文添加
	DWORD                               dwServerAddrCUN;                    //联通房间地址 彭文添加

	
	DWORD								dwOnLineCount;						//在线人数
	DWORD                               dwMaxCount;                         //最大在线人数 彭文添加
	TCHAR								szServerName[SERVER_LEN];			//房间名称

	LONG                                lRestrictScore;                     //彭文添加 限制积分
	LONG								lRestrictGrade;                     //限制等级
	LONG							    lEnterMoney;                        //进入游戏最低金币
	LONG                                lCellScore;                         //彭文添加 单位积分
...
#define USER_PLACARD_TITLE_LEN          32                                  //消息标题长度
#define USER_PLACARD_CONTENT_LEN        512                                 //消息的长度u
