...
{
	WORD							wKindID;							//名称号码
	WORD							wChairCountMin; //彭文修改    WORD   wChairCountMin; //椅子数目
	WORD                            wChairCountMax; //彭文添加
...
struct tagGameServiceOption
{
	...
	DWORD                           dwServerAddrCUN;                    //连同房间地址 彭文添加
	...
	DWORD                             wAndroidTableCount;                 //机器人最低站位的桌子数 彭文添加 
	                                                                      //比如如果斗地主 wAndroidTableCount = 10意味着至少有30个机器人会站位
	DWORD                             wUserWaitUntilAndroid;              //用户等待时间
};
